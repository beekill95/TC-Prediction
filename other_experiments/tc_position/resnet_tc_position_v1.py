...
# Build the model with multi-objectives.

# +
baseline_model = models.resnet.ResNet18(
...
baseline_model_output = keras.layers.Flatten()(baseline_model.output)
tc_location_regression_output = models.layers.tc_position_regression_layers(
    baseline_model_output, name=baseline_model.name)
tc_formation_pred_output = models.layers.tc_formation_prediction_layers(
    baseline_model_output, name=baseline_model.name)

model = keras.Models(
    inputs=baseline_model.inputs,
    outputs=[tc_formation_pred_output, tc_location_regression_output])
