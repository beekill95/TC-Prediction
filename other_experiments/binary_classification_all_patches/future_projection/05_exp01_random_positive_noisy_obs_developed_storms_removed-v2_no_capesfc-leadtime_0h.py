...
train_negative_path = 'data/ncep_WP_EP_0h_all_binary_patches_all_varibles_no_capesfc_developed_storms_removed_v2_Train.tfrecords'
...
train_random_positive_path = 'data/ncep_WP_EP_6h_full_domain_developed_storms_removed_v2_no_capesfc_Train.tfrecords'
...
model.save(f'saved_models/random_positive_no_pca_developed_storms_removed_v2_no_capesfc_leadtime_0h_f1_{metrics[-1]:.3f}')
