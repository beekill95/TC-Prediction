...
for X, y in iter(train_RCP45_fixed_patches_ds):
    print(X)
    isnan = np.isnan(X)
    print(np.any(isnan, axis=(0, 1)))
    break
...
model.save(f'saved_models/a_bit_future_RCP45_random_positive_no_pca_developed_storms_removed_v2_no_capesfc_leadtime_0h_f1_{metrics[-1]:.3f}')
