...
train_negative_path = 'data/ncep_WP_EP_6h_all_binary_patches_all_variables_remove_outside_grouped_Train.tfrecords'
...
train_random_positive_path = 'data/ncep_WP_EP_6h_all_Train.tfrecords'
random_positive_patch_dataloader = RandomPositivePatchesDataLoader(
    datashape=(41, 161, 136), domain_size=31)
...
model.save(f'saved_models/random_positive_f1_{metrics[-1]:.3f}')
