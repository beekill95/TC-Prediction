...
# Try everything from 1000 to 500mb
subset = dict(
    absvprs=[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500],
    rhprs=[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500],
    tmpprs=[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500],
    hgtprs=[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500],
    vvelprs=[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500],
    ugrdprs=[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500],
    vgrdprs=[1000, 975, 950, 925, 900, 850, 800, 750, 700, 650, 600, 550, 500],
)
data_shape = (41, 161, 93)
# -
