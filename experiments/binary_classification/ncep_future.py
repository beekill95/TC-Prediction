...
_, rcp45_val_ds, rcp45_test_ds = dataloader_theanh.load_dataset(
    future_rcp45_path, val_split=0.2, test_split=0.8, shuffle=False)
...
preprocessing.layers[0].adapt(ncep_train_ds.map(lambda X, _: X))
# -
